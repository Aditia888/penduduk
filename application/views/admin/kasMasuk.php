        ...
        <div class="page-content--bgf7">
        										...
        										<tr>
        											...
        											<td>
														...
														if ($msk->buktiPembayaran != '') {
															echo "<small><a href='" . base_url('uploads/bukti_pembayaran/' . $msk->buktiPembayaran) . "' target='_blank'>Bukti Pembayaran</a></small>";
														}
														?>
        											</td>
        											<td><?php
        											...
        											<td>
        												<div class="table-data-feature">
        													<?php if ($msk->status_persetujuan == 0) { ?>
        														<button class="item" data-toggle="modal" data-target="#setujuiPembayaranKas<?= $msk->idKas; ?>" data-placement="top" title="Setujui">
        															<i class="zmdi zmdi-check" style="color: green;"></i>
        														</button>
        														<button class="item" data-toggle="modal" data-target="#tolakPembayaranKas<?= $msk->idKas; ?>" data-placement="top" title="Tolak">
        	...
        	<!-- modal addKasMasuk -->
        	<div class="modal fade" id="addKasMasukModal" role="dialog" aria-labelledby="addKasMasukModal" aria-hidden="true" style="overflow:hidden;">
			...
			foreach ($masuk as $val): $no++; ?>
        		<div class="modal fade" id="editKasModal<?= $val->idKas; ?>" role="dialog" aria-labelledby="editKasModal" aria-hidden="true" style="overflow:hidden;">
