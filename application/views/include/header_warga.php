            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color: #393939 !important;">
                ...
                <div class="collapse navbar-collapse" id="mainNavbar">
                    <ul class="navbar-nav mx-auto">
                        ...
                        <li class="nav-item mr-3">
                            <a class="nav-link text-white" href="<?= base_url('kas'); ?>">
                                <i class="fas fa-money-bill"></i> Pembayaran Kas/Sampah
                            </a>
                        </li>
                        ...
                        <li class="nav-item mr-3">
                            <a class="nav-link text-white" href="<?= base_url('kritikSaran'); ?>">
                                <i class="zmdi zmdi-comment-text"></i> Kritik & Saran
                            </a>
                        </li>
